...
[`@aws-sdk/client-partnercentral-channel`](https://www.npmjs.com/package/@aws-sdk/client-partnercentral-channel/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-channel@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pZtgIgEnaM1R613RLrjV4ziD2+sqkgZCmuoE+OcMTteDOd14MrnJujiZD+0Gosjl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-partnercentral-channel": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-channel@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-channel@3.971.0/index.min.mjs": "sha384-pZtgIgEnaM1R613RLrjV4ziD2+sqkgZCmuoE+OcMTteDOd14MrnJujiZD+0Gosjl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-partnercentral-channel/blob/refs/tags/3.971.0/LICENSE
```
