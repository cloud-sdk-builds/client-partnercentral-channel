...
[`@aws-sdk/client-partnercentral-channel`](https://www.npmjs.com/package/@aws-sdk/client-partnercentral-channel/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-channel@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xuXtOwlYMen7cUdPyX4z0rjhtZZcvX1WBIWpdZSXLO1KDfqPDOzumAiqJPWKGWnY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-partnercentral-channel": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-channel@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-channel@3.989.0/index.min.mjs": "sha384-xuXtOwlYMen7cUdPyX4z0rjhtZZcvX1WBIWpdZSXLO1KDfqPDOzumAiqJPWKGWnY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-partnercentral-channel/blob/refs/tags/3.989.0/LICENSE
```
