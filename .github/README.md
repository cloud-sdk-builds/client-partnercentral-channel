...
[`@aws-sdk/client-partnercentral-channel`](https://www.npmjs.com/package/@aws-sdk/client-partnercentral-channel/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-channel@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PJyqbB4mANMjHvcekxGKoF3r9leCe8trE3XOmNUp6DbEcLAT9wC9isSMr/NFQaq8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-partnercentral-channel": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-channel@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-channel@3.964.0/index.min.mjs": "sha384-PJyqbB4mANMjHvcekxGKoF3r9leCe8trE3XOmNUp6DbEcLAT9wC9isSMr/NFQaq8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-partnercentral-channel/blob/refs/tags/3.964.0/LICENSE
```
